...
#   affect tradition formation, as well as genetic transmission fidelity (h)
#
...
#
# GENETIC INHERITANCE:
#   - mutation_rate  : 1 - h, with h being an analogous of genetic heritability
#
# POPULATION DYNAMICS:
  ...
  for(g in 1:tmax) {
    ...
    if (length(pos_fR) > 0) { # If reproductive females exist
      if (nb_newborns > 0) { # And population has space for offspring
        ...
        # GENETIC TRANSMISSION PROCESS: Introduces genetic variation
