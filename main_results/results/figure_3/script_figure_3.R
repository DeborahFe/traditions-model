...
plot_dynamics_cultural <- ggplot(data = dynamics_cultural, aes(x = iteration)) + 
  ...
  #          label = expression(paste(c, " = 0.7, ", n[obs], " = 12, ", h, " = 0.6")),
  #          colour = "grey40") +
  annotate("text", x = 145, y = 0.9,
           label = "c = 0.7, n[obs] = 12, h = 0.6",
           colour = "grey40") +
...
plot_dynamics_cultural_null <- ggplot(data = dynamics_cultural_null, aes(x = iteration)) + 
  ...
  # annotate("text", x = 140, y = 0.9,
  #          label = expression(paste(c, " = 0.5, ", n[obs], " = 12, ", h, " = 0.6")),
  #          colour = "grey40") +
  annotate("text", x = 145, y = 0.9,
           label = "c = 0.5, n[obs] = 12, h = 0.6",
           colour = "grey40") +
...
plot_dynamics_geneculture <- ggplot(data = dynamics_geneculture, aes(x = iteration)) + 
  ...
  # annotate("text", x = 140, y = 0.9,
  #          label = expression(paste(c, " = 0.7, ", n[obs], " = 5, ", h, " = 0.6")),
  #          colour = "grey40") +
  annotate("text", x = 145, y = 0.9,
           label = "c = 0.7, n[obs] = 5, h = 0.6",
           colour = "grey40") +
...
plot_dynamics_geneculture_null <- ggplot(data = dynamics_geneculture_null, aes(x = iteration)) + 
  ...
  # annotate("text", x = 140, y = 0.9,
  #          label = expression(paste(c, " = 0.5, ", n[obs], " = 5, ", h, " = 0.6")),
  #          colour = "grey40") +
  annotate("text", x = 145, y = 0.9,
           label = "c = 0.5, n[obs] = 5, h = 0.6",
           colour = "grey40") +
...
boxplot_cultural <- ggplot(traditions_cultural_sub, aes(x = c, y = tradition_duration, color = exaggeration)) + 
  ...
  #          label = expression(paste(n[obs], " = 5, ", h, " = 0.6")),
  #          colour = "grey40") +
  annotate("text", x = 9, y = 50,
           label = "n[obs] = 5, h = 0.6",
           colour = "grey40") +
...
pdf(file="figure_3.pdf", width = 11, height = 9)
temporal_dynamics_and_boxplots
dev.off()
